...
int main(int argc, char *argv[]){
  ...
  cout << "Greedy Search:" << endl << endl;
  solution = gsearch.GSearch(origin, destiny, graph);  // Armazena o vetor de solução em solution
  
  cout << "Solution (Explored cities): " << "[ ";
